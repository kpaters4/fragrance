...
| `/clusters` | GET | A sampled, 2D-projected view of the corpus grouped into 14 note-based clusters, each labeled with a named subfamily from the Michael Edwards Fragrance Wheel (e.g. "Dry Woods") and colored by that subfamily's main wheel family (Floral, Amber, Woody, Fresh), for the clusters visualization |
